...
import com.globalmentor.rdf.xmlschema.Base64BinaryLiteral;

/**
 * Crypto digest information.
 * @author Garret Wilson
 */
public class Digest extends TypedRDFResource {
	...
	/**
	 * Sets the <code>crypto:digestMethod</code> property of the digest to a digest method with the given algorithm.
	...
	/**
	 * Sets the <code>crypto:digestMethod</code> property of the digest to a digest method with the given algorithm identifier.
	...
	/**
	 * Retrieves the digest method algorithm of the resource. If this resource has more than one property of <code>crypto:digestMethod</code>, it is undefined
	 * which of these property values will be returned.
	 * @return The digest method algorithm of the resource, or <code>null</code> if there is no digest method or the digest method is not of the correct type, or
	 *         the digest method has no algorithm specified.
	 * @see #getDigestMethod()
	 */
	...
	/**
	 * Retrieves the digest method of the resource. If this resource has more than one property of <code>crypto:digestMethod</code>, it is undefined which of
	 * these property values will be returned.
	...
	/**
	 * Retrieves the digest value of the resource. If this resource has more than one property of <code>crypto:digestValue</code>, it is undefined which of these
	 * property values will be returned.
	 * @return The digest value of the resource, or <code>null</code> if there is no digest value or the digest value is not of the correct type.
	 */
