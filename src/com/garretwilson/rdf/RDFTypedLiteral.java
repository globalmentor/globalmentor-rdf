...
public class RDFTypedLiteral extends RDFLiteral
{
	...
	*/
	...
	/**If <code>object</code> is another <code>RDFTypedLiteral</code>, compares the
		value objects. Compares the
	...
	*/
	public boolean equals(final Object object)
	{
		...
		{
			return getValue().equals(((RDFTypedLiteral)object).getValue()); //compare values
		}
