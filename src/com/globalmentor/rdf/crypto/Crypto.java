...
<p>This class also serves as a resource factory that knows how to 
	create RDF resources for Crypto resource descriptions.</p>
...
public class Crypto implements RDFResourceFactory
{
	...
	*/
	...
	/**Retrieves the digest value of the resource. If this resource has more
		than one property of <code>crypto:digest</code>, it is undefined which
		of these property values will be returned.
	@param resource The resource the digest of which will be returned.
	@return The digest of the resource, or <code>null</code> if there is no
		algorithm or the algorithm is not of the correct type.
	*/
	...
	<p>This implementation creates Crypto-specific resources.</p>
