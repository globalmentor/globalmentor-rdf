...
public class BooleanLiteral extends RDFTypedLiteral<Boolean> {
	...
	/**
	 * Determines if the RDF object is a boolean literal and, if so, casts the object to a boolean literal and returns it.
	...
	/**
	 * Determines if the RDF object is a boolean literal and, if so, casts the object to a boolean literal and returns its value; otherwise, returns
	 * <code>false</code>.
	 * @param rdfObject The RDF object in question.
	 * @return The boolean value of the boolean literal, or <code>false</code> if the object is not a boolean literal or the object is <code>null</code>.
	 */
	...
	/**
	 * Determines if the RDF object is a boolean literal and, if so, casts the object to a boolean literal and returns its value; otherwise, returns the given
	 * default.
	 * @param rdfObject The RDF object in question.
	 * @param defaultValue The default boolean value to return if the object is not a boolean literal.
	 * @return The boolean value of the boolean literal, or <var>defaultValue</var> if the object is not a boolean literal or the object is <code>null</code>.
	 */
