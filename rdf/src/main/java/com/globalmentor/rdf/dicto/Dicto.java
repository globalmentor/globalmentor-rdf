...
public class Dicto implements RDFResourceFactory {
	...
	public static final URI DICTO_NAMESPACE_URI = URI.create("http://globalmentor.com/namespaces/2003/dicto#");

	//Dicto class names
	/** The local name of dicto:Dictionary. */
	public static final String DICTIONARY_CLASS_NAME = "Dictionary";
	/** The local name of dicto:Word. */
	public static final String WORD_CLASS_NAME = "Word";
	...
	public static final String ENTRIES_PROPERTY_NAME = "entries";
	...
	public static final String NUMBER_PROPERTY_NAME = "number";
	/** The orthography of an entry. The local name of dicto:orthography. */
	public static final String ORTHOGRAPHY_PROPERTY_NAME = "orthography";
	/** The pronunciation of an entry. The local name of dicto:pronunciation. */
	public static final String PRONUNCIATION_PROPERTY_NAME = "pronunciation";
	/** The part of speech of an entry. The local name of dicto:speechPart. */
	public static final String SPEECH_PART_PROPERTY_NAME = "speechPart";
	...
	public static final String TRANSLITERATION_PROPERTY_NAME = "transliteration";
