...
/**
 * Class representing a word that can be part of a Dictionary Ontology (Dicto) dictionary.
...
public class Word extends Entry {
	...
	/**
	 * @return The part of speech of the word, or <code>null</code> if there is no part of speech.
	...
	/**
	 * @return The gender of the word, or <code>null</code> if there is no gender.
	 * @throws ClassCastException Thrown if the property object is not a plain literal.
	 */
