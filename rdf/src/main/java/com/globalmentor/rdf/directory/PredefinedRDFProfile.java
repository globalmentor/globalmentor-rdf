...
public class PredefinedRDFProfile extends PredefinedProfile implements RDFPropertyFactory, RDFPropertyValueFactory {
	 ...
	 * @return The property URI associated with this type name, or <code>null</code> if no property URI has been registered with the type name.
	 */
	...
	/**
	 * Creates an RDF property resource to represent the given directory content line.
	...
	/**
	 * Creates an RDF object to represent the value of the given directory content line.
	 * @param rdf The RDF data model to use when creating the RDF objects.
	 * @param contentLine The directory content line to be converted to an RDF object.
